...
class ArtPrompt(BaseModel):
    prompt: str = Field(None, description='The role of the entity asking the question (e.g., "ai", "user").')


class PersonalPainterPrompt:
    
    def __init__(self, 
                 api_key: Optional[str] = None, 
                 model_name: str = "gemini-2.0-flash",
                 langsmith_api_key: Optional[str] = None,
                 prompt_repo: str = "dharmendra622/dz_pp_prompt_generation"):
        """
        ...
        self.output_parser = PydanticOutputParser(pydantic_object=ArtPrompt)
    ...
    def next_chat(self, chat_history: List=[]) -> ArtPrompt:
